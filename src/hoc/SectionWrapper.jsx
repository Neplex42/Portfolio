...
const StarWrapper = (Component, idName) =>
  function HOC() {
    return (
      <motion.section 
      // le composant rendu est un motion.section, un composant de Framer Motion utilisé pour ajouter des animations.
        ...
        // configure la détection de la vue, lorsque le composant est visible à au moins 25% à l'écran.
        className={`${styles.padding} max-w-7xl mx-auto relative z-0`}
      >
        <span className='hash-span' id={idName}>
          &nbsp;
        </span> 
        {/* utilisé comme point d'ancrage pour le défilement ou la navigation vers une section spécifique de la page */}
